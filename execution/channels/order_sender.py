"""
execution/channels/order_sender.py —async sender for OkxChannel signed requests
=================================================================================

DeepSeek's ``OkxChannel`` (Rust) only *signs* and returns request JSON bytes —it never touches the network (to avoid nesting an async runtime inside Python's
